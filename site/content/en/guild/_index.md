  ...
  - title: Guild meetings
    ...
    items:
      - name: Annual Assembly
        desc: February–March · the annual report, the financial statement and discharge.
      - name: Electoral Assembly
        desc: October–November · next year's board, committees and officials.
  - title: Joining the guild
    body: "All undergraduate and master's students of Industrial Engineering and Management at Aalto University who have paid the membership fee can be approved as actual members. New students need not join before their studies begin: orientation week gives everybody a chance to pay the fee."
    items:
      - name: Membership 8 €
        desc: Per academic year. Applications open after June for the coming academic year.
...
docs:
  ...
  - label: Guidelines
    url: /en/guild/rules/guidelines/
  - label: Decrees
    url: /en/guild/rules/decrees/
  - label: Honours
    url: /en/guild/honour/
  # The minutes themselves sit behind the member gate, and check-trees.sh
  # forbids the public tree from naming any address below /en/members/. The
  # landing page is the door and is published on purpose.
