...
- [I Queue and registration decree](#i-queue-decree-and-registration)
- [II Moderating decree](#ii-moderation-decree)
- [III Decree on the guild's bank card](#iii-decree-on-the-guilds-bank-card)
- [IV Brand decree](#iv-branding-decree)
...
- column that is used to marking the first call of the queue that the queuer has missed
...
Anyone on the list may call through the list, provided that at least half an hour has elapsed since both the last shouting and the establishment of the list. The list is called out by calling out the names in order. If a queue member is not present, they will lose their place and the name will be neatly crossed off the list. Every queue member has the right to miss one queue call during the whole queuing. The first call that the person misses and its timestamp is marked in the column available in the queue list. If the person in the queue misses any more calls they are therefore considered to have left their place in the queue. Exceptions to this rule are those persons who, by virtue of their duties, are required to organise events or represent the Guild. It is also allowed to leave the queue for an exam. In this case, these queuing persons do not lose their place in the queue during the organisation of the event or the examination. In such cases, the organiser of the event and other queue holders (if possible) must be informed at least 24 hours before the leaving the queue. Any doubtful cases will be submitted to the decision of the guild board. The organiser of the event (for which the queue is being taken) may also suspend the queue for the duration of the guild event. The person queuing can only add their name to the list and cannot queue nor register for events on behalf of anyone other than themselves. If a companion can be brought to the event, the companion will also be added to the waiting list by adding +avec to their own name after their own name.
