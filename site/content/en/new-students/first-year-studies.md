...
Course content can be found on [MyCourses](https://mycourses.aalto.fi).

Information about IEM master can be found on IEM Department's page: [the IEM Department's page](https://www.aalto.fi/en/department-of-industrial-engineering-and-management).

Enrollment to courses needs to be done on Sisu: [Sisu](https://sisu.aalto.fi/student/login)
