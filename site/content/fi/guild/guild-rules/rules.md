...
description: Tuotantotalouden kilta Prodeko ry:n syksyllä 2023 päivitetyt säännöt luvuittain ja pykälittäin.
translationKey: guild-guild-rules-rules
sourceURL: https://prodeko.org/fi/guild/guild-rules/rules/
---
...
Toimintansa tukemiseksi kilta voi järjestää huvitilaisuuksia, arpajaisia, harrastaa alaan liittyvää
 ...
 jäsenmaksuja. Kilta voi omistaa kiinteää ja irtainta omaisuutta. Kilta voi harjoittaa yhdistyslain 5§ mukaista liiketoimintaa tarkoituksensa toteuttamiseksi, mutta ei hanki taloudellista etua tai ansiota
...
Kilta kokoontuu ylimääräiseen kokoukseen hallituksen päätöksellä tai kun kiltakokous niin päättää
 ...
 killan varsinaisista jäsenistä sitä kirjallisesti hallitukselta vaatii. Kokous on tällöin pidettävä neljän (4) viikon kuluessa vaatimuksen jättämisestä hallitukselle.
...
Kokouksessa käsitellään kokouskutsussa mainitut asiat. Kokous voi myös ottaa käsiteltäväkseen
 asian, jonka kokous kolmen neljäsosan (3/4) enemmistöllä annetuista äänistä julistaa kiireelliseksi ottaen huomioon yhdistyslain 24 § määräykset. Käsiteltäessä killan sääntöjen muuttamista,
...
Hallituksen alaisena voi toimia toimikuntia ja toimihenkilöitä. Kiltakokous nimeää tarvittaessa
 ...
 toimikuntia sekä julistaa haettavaksi toimia ja valita toimihenkilöitä. Haettavista toimista on ilmoitettava 43§ mukaisella ensisijaisella ilmoitustavalla vähintään kaksi (2) viikkoa ennen hallituksen kokousta, jossa päätös kyseisten toimihenkilöiden nimeämisestä tehdään.
...
Killan taloudenhoitoa valvovat tilintarkastajat/toiminnantarkastajat, joille hallituksen on
 ...
 Tilintarkastajien/toiminnantarkastajien ja heidän varahenkilöiden määrästä säädetään sääntöjen 17§.
...
Kilta purkautuu, mikäli kiltakokous niin päättää kolmen neljäsosan (3/4) ääntenenemmistöllä
 ...
 on mainittava kokouskutsussa. Killan purkauduttua tai sen tultua lakkautetuksi luovutetaan sen varat Aalto-yliopiston ylioppilaskunnan käytettäväksi näiden sääntöjen 2§ mukaiseen toimintaan
